	...
	private class DownloadWebpageTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			try {
				...
				final Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/ebrima.ttf");
				...
				runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						((TextView) findViewById(R.id.article_content)).setText(Html.fromHtml(finalContent));
						((TextView) findViewById(R.id.article_title)).setText(titleText);
						((TextView) findViewById(R.id.article_author)).setText(authorText);

						((TextView) findViewById(R.id.article_content)).setTypeface(tf);
						((TextView) findViewById(R.id.article_title)).setTypeface(tf, Typeface.BOLD);
						((TextView) findViewById(R.id.article_author)).setTypeface(tf, Typeface.ITALIC);
					}
